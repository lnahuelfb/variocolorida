    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <figure className={styles.imageContainer}>
          <Image className={styles.image} src='/images/logo.png' alt="Logo de Variocolorida" width={105} height={82} />
        </figure>
        ...
        <div className={styles.social}>
          ...
          <figure className={styles.socialContainer}>
            <a href="https://www.instagram.com/variocolorida/" target='_blank' rel="noopener noreferrer">
              <Image className={styles.image} src='/images/instagramlogo.svg' alt='Ir al perfíl de Instagram' width={35} height={35} />
            </a>
          </figure>

          <figure className={styles.socialContainer}>
            <a href="https://www.behance.net/aguspedem" target='_blank' rel="noopener noreferrer">
              <Image className={styles.image} src='/images/behancelogo.svg' alt='Ir al perfíl de Behance' width={35} height={35} />
            </a>
          </figure>
